...
class BannerView extends StatefulWidget {
  ...
  BannerView(double this.height, List<BannerItem> this.datas,
      {Key key,
        int this.duration = 3000,
        double this.pointRadius = 3.0,
        Color this.selectedColor = Colors.grey,
  ...
  State<StatefulWidget> createState() {
    ...
    return BannerStateView();
  }

}

class BannerStateView extends State<BannerView> {
